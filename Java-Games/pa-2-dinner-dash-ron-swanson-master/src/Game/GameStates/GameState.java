...
import Game.Entities.Static.OnionRingCounter;
import java.awt.*;
...
public class GameState extends State {
    ...
    public GameState(Handler handler){
        ...
        BaseCounter Counters[] = {
                ...
                new MagicCounter(BaseCounter.DEFAULTCOUNTERWIDTH*8, 593,handler),
        		new OnionRingCounter(BaseCounter.DEFAULTCOUNTERWIDTH *4, 600,handler)};
