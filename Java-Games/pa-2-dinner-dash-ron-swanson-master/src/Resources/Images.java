...
public class Images {
    ...
    public static BufferedImage[] kitchendoor;
    ...
    public Images() {
        ...
        kitchendoor = new BufferedImage[2];
        try {
            ...
            title = ImageIO.read(getClass().getResourceAsStream("/Sheets/Overcooked.jpg"));
            Pause = ImageIO.read(getClass().getResourceAsStream("/Sheets/Pause.png"));
            welcome = ImageIO.read(getClass().getResourceAsStream("/Sheets/Welcome.png"));
            floor = ImageIO.read(getClass().getResourceAsStream("/Sheets/Floor2.jpg"));
            ...
            kitchendoor[0] = kitchenSpriteSheet.crop(70,90,50,65);
            ...
            kitchenCounter[8] = kitchenCounterSpriteSheet.crop(33,76, 30, 56);//Onion
            ...
            ingredients[7] = burgerSpriteSheet.crop(311, 120, 102, 39); // Onion Rings
