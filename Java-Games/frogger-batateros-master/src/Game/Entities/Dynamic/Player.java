...
public class Player extends EntityBase {
	...
	public void move(){
		...
		/////////////////MOVE UP///////////////
		//Implemented UP Parameter.
		if(handler.getKeyManager().keyJustPressed(KeyEvent.VK_W) && !moving && facing.equals("UP") && player.getY() > ( this.getY() % 64)){
			moving=true;
		...
		//Added a new else if statement that measures the boundaries of the left movement.
		else if(handler.getKeyManager().keyJustPressed(KeyEvent.VK_A)  && !moving && facing.equals("LEFT") && player.getX() < (64 - this.getX() % 64) ){
			moving=false;
		}
		...
		/////////////////MOVE DOWN///////////////
		//Implemented Down parameter
		else if(handler.getKeyManager().keyJustPressed(KeyEvent.VK_S) && !moving && facing.equals("DOWN") && player.getY() > (64*10  - this.getY() % 64)){
			moving=false;
		}
		...
		/////////////////MOVE RIGHT///////////////
		//Boundaries to the right of the game.
		else if(handler.getKeyManager().keyJustPressed(KeyEvent.VK_D) && !moving && facing.equals("RIGHT") && player.getX() > (64 * 7 + this.getX() % 64)){
			moving=false;
		}
